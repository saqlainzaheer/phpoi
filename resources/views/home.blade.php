          ...
          <div class="col-lg-6 col-md-6 col-sm-6 col-12 r-number">
            <a href="#" class="prevbtn" style="display:none;">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M7.20535 7.23047L3.87202 10.5638L3.57739 10.8584L3.87202 11.153L7.20535 14.4864L7.7946 13.8971L5.17257 11.2751H17.0833V10.4418H5.17257L7.7946 7.81972L7.20535 7.23047Z" fill="white" />
              </svg>
            </a>
            <a href="#" style="display:none;" class="nextbtn ">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M13.4554 7.23047L16.7887 10.5638L17.0833 10.8584L16.7887 11.153L13.4554 14.4864L12.8661 13.8971L15.4881 11.2751H3.57739V10.4418H15.4881L12.8661 7.81972L13.4554 7.23047Z" fill="white" />
              </svg>
            </a>
          </div>
        </div>
  ...
  <div class="container">
      ...
      <div class="col-lg-10 mx-auto">
        <div class="row">
          ...
          <div class="col-lg-8 homeat">
            <h4>Data Integrity Services stands as a premier technology and consulting partner, offering comprehensive end-to-end solutions within the Microsoft ecosystem. As a dedicated team of subject matter experts, including Microsoft certified professionals. We are committed to delivering outstanding results for your business.</h4>
    ...
    <div class="maincontainer">
      <figure>
        ...
        <figcaption>
          <p>DIS Reduces 20% in Supply Chain inefficiencies for a Global Retail Chain with Unified Data Platform and enhanced decision-making.</p>
          <a href="#" class="caseset"><span></span>  By partnering with Microsoft Azure, Data Integrity Services (DIS) executed a Unified Data Platform for a leading Global Retail Chain which helped them reduce 20% of inefficiencies in their logistics network, and improved quality of their data with Unified BI dashboards.</a>
        </figcaption>
      </figure>
      <figure>
        ...
        <figcaption>
          ...
          <a href="#" class="caseset"><span></span>Data Integrity Services conducted a secure cloud migration to Microsoft Azure for a financial institution of thousands, through which several security measures and adherence management were noticed.</a>
        </figcaption>
      </figure>
      <figure>
        <div class="imgseccont">
        ...
        <figcaption>
          <p>Upgrading from Equipment Breakdowns of a Manufacturing Plant to Significant Cost Savings by AI-Driven Maintenance on Microsoft Azure.</p>
          <a href="#" class="caseset"><span></span>Data Integrity Services outcame a drowning Manufacturing Plant with 30% reduction in their equipment downtime by analysing the past breakdowns resulting in overall improvement of the plant’s infrastructure by their AI-Driven Maintenance Technologies.
</a>
        </figcaption>
      </figure>
      <figure>
        ...
        <figcaption>
          <p>DIS Streamlines Customer Interactions of an MNC by Customer Relationship Management (CRM), powered by Microsoft Azure.</p>
          <a href="#" class="caseset"><span></span>Data Integrity Services helped a Multinational Corporation with efficient collaboration, keeping customer satisfaction in priority, which improved their user adoption by 40%. This outcome came as a positive result with effective Customer Relationship Management by user-friendly Power Apps Interface, integrated with Azure.</a>
        </figcaption>
      </figure>
      <figure>
        <div class="imgseccont">
        ...
        <figcaption>
          <p> Helping Multinational Sales Organizations struggling with real-time insights with the implementation of  Sales Performance Dashboard</p>
          <a href="#" class="caseset"><span></span>Data Integrity Services helped a a Multinational Sales Organization with 25% increase in their sales revenue with real-time insights and targeted sales strategies, advancing the collaboration among the sales team region-wise. DIS made it possible by integrating data from CRM systems, Excel Spreadsheets, and ofcourse by the efforts of its hard-working team with the help of Power BI Automated Dashboards.</a>
        </figcaption>
      </figure>
      <figure>
        <div class="imgseccont"> <img src="{{ asset('web/images/mis-img-6.png') }}"alt="Dis" /></div>
        <figcaption>
          <p> Reduced 30% in Onboarding Time and Paperwork of a large HR Management with Power Automation and Azure AI Services.</p>
          <a href="#" class="caseset"><span></span>Data Integrity Services helped a large HR Department facing difficulties in managing employee onboarding and performance evaluation data by introducing AI-driven insights to advance their processes. With our Power Automation and Azure AI Services, decision-making of the AI-infused HR management was enhanced due to which employees were satisfied through their personalized performance insights.</a>
...
<section class="oursolution">
  <div class="container">
    <div class="row solutionvideo">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="rc">
          <video src="{{ asset('web/images/vidsolution.mp4') }}" id="localVideoStream" class="video-circle" width="700px" height="700px" autoplay muted loop></video>
        </div>
      </div>
    </div>
  </div>
...
<section class="latestinsights">
  ...
  <div class="owl-carousel owl-sight owl-theme">
    ...
    <div class="item">
      ...
      <div class="boxmember">
        <!-- <h6><span class="dot"></span>White Paper</h6> -->
        <h5>Crafting a smooth blend that ensures your data's integrity is rock-solid with our cutting-edge AI, BI, and ML technologies.</h5>
      </div>
    </div>
    <div class="item">
      <div class="sightcorsual">
      ...
      <div class="boxmember">
        <!-- <h6><span class="dot"></span>White Paper</h6> -->
        <h5>Adapting to evolve patterns and ensuring the highest standards of accuracy through Machine Learning, refining and optimizing data processes.</h5>
      </div>
    </div>
    <div class="item">
      <div class="sightcorsual">
    ...
    <div class="item">
      ...
      <div class="boxmember">
        <!-- <h6><span class="dot"></span>White Paper</h6> -->
        <h5>Employing advanced techniques to adapt and fortify the data against evolving risks with our dynamic security layers</h5>
      </div>
    </div>
    <div class="item">
      <div class="sightcorsual">
          ...
          <div class="reviewdesign">
            <div class="row">
              ...
              <div class="col-lg-9 col-md-9 col-sm-6 col-12">
                <p class="reviewpara">It's all about getting your message in front of the right audience and creating those valuable relationships. Learn More about how DOML can help you do just that - all with a simple, easy-to-use platform.</p>
