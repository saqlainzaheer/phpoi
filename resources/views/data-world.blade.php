        ...
        <div class="row mb-4">
          <div class="col-lg-4">
            <div class="joinusbox">
              ...
              <p>Expertise in extracting value from large datasets through the integration and management of cloud-based solutions.</p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="joinusbox">
              ...
              <p>Implementing intelligent algorithms by incorporating Machine Learning and Artificial Intelligence for advanced decision-making.</p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="joinusbox">
        ...
        <div class="row mb-4">
          <div class="col-lg-4">
            <div class="joinusbox">
              ...
              <p>Tailoring the power of data to derive meaningful insights by optimizing your computing infrastructure.</p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="joinusbox">
              ...
              <p>Transmitting data as it is generated in real time, and capturing events for later analysis & retrieval.</p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="joinusbox">
              ...
              <p>Crafting complex data in a way that tells a clear & coherent story through visually engaging narratives to enhance data presence.</p>
            </div>
          </div>
        </div>
    ...
    <section class="buildfaster pt-0">
      <div class="container">
        ...
        <div class="maincontainer">
          ...
          <a href="{{URL('/study/dis-reduces-supply-chain-inefficiencies')}}" class="caseset"><span></span> Read more</a>
            </figcaption>
          </figure>
          <figure>
          ...
          <a href="{{URL('/study/dis-saves-large-financial-institution')}}" class="caseset"><span></span> Read more</a>
            </figcaption>
          </figure>
          <figure>
            <div class="imgseccont">
            ...
            <figcaption>
            <p> Upgrading from Equipment Breakdowns of a Manufacturing Plant to Significant Cost Savings by AI-Driven Maintenance on Microsoft Azure.
</p>
          <a href="{{URL('/study/upgrading-from-equipment-breakdowns')}}" class="caseset"><span></span> Read more</a>
            </figcaption>
          </figure>
          <figure>
          ...
          <a href="{{URL('/study/dis-streamlines-customer-interactions')}}" class="caseset"><span></span> Read more</a>
            </figcaption>
          </figure>
          <figure>
            <div class="imgseccont">
          ...
          <a href="{{URL('/study/helping-multinational-sales-organizations')}}" class="caseset"><span></span> Read more</a>
            </figcaption>
          </figure>
          <figure>
          ...
          <a href="{{URL('/study/reduced-onboarding-time-and-paperwork')}}" class="caseset"><span></span> Read more</a>
            </figcaption>
          </figure>
        </div>
      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="tel" name="" placeholder="+1 012 3456 789" class="form-control" value="">
                    </div>
                  </div>
                </div>
                <div class="row">
