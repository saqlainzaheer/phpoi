...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:wght@400;500;600&family=Inter:wght@100;200;300;400;500;600&family=Play:wght@400;700&family=Plus+Jakarta+Sans:wght@200;300;400;500;600;700&display=swap" rel="stylesheet">
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="nav nav-pills d-flex align-items-center ">
                  <li class="nav-item"><a href="{{url('we-are')}}" class="nav-link" aria-current="page">We Are</a></li>
                  <li class="nav-item"><a href="{{url('our-services')}}" class="nav-link">Services</a></li>
                  <li class="nav-item"><a href="{{url('data-world')}}" class="nav-link">Data World</a></li>
                  ...
                  <li class="nav-item"><a href="{{url('cloud-providers')}}" class="nav-link">Cloud Providers</a></li>
