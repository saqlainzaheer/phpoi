...
<section class="wecarepart">
    <div class="container">
        <div class="row mb-75 globeheading">
            ...
            <div class="col-lg-6">
                <p>Data Integrity Services is your go-to technology and consulting partner, offering complete solutions
                    within
                    the Microsoft ecosystem. Our dedicated team of subject matter experts, including Microsoft-certified
                    professionals, is committed to delivering outstanding results for your business.</p>
                <ul class="globelisting">
                    <li>Data Integrity Services excels in the Microsoft ecosystem, known for delivering top-notch
                        technology
                        solutions.</li>
                    <li>As a trailblazer in data management, we provide innovative end-to-end solutions within
                        Microsoft's domain.
                    </li>
                    <!-- <li>Proudly holding the title of Azure Expert MSP (Managed Service Provider) partner.</li> -->
                    <li>Recognized for our cloud computing excellence, we proudly hold the title of a Trusted Microsoft
                        Partner,
    ...
    <div class="container">
        <div class="row cloudimgrev">
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="textcloud">
                    <h3>Microsoft Experts for Two Decades</h3>
                    <p>Data Integrity Services (DIS) has stood as a stalwart Microsoft partner showcasing expertise and
                        unwavering
                        dedication in the realm of cloud computing, for a long time. With the saddling power of
                        Microsoft
                        Technologies, we enable clients to navigate the evolving landscape of digital innovation with
                        confidence and
                        precision. As a trusted ally, DIS continues to elevate businesses by integrating cutting-edge
                        solutions that
                        ensure data integrity & security, and empower organisations to thrive in the dynamic world of
                        technology.
                    </p>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="imgcall"> <img src="{{ asset('web/images/cloud-pro-img01.jpg') }}"></div>
            </div>
        </div>
    </div>
</section>
<section class="right-leftpart">
    <div class="container">
        <div class="row cloudimgrev">
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="imgcall"> <img src="{{ asset('web/images/cloud-pro-img02.jpg') }}"></div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="textcloud">
                    <h3>All Three Clouds</h3>
                    <p>We cover Microsoft's 3 clouds:</p>
                    <ol>
                        <li>Microsoft 365</li>
                        <li>Azure</li>
                        <li>Dynamics</li>
                    </ol>
                    <p>Holding the exclusive Azure Expert MSP status, awarded to partners showcasing profound technical
                        expertise
                        in Azure, we guide customers in adopting and maximizing their Microsoft technology.
                        Our focus extends to optimizing license and cloud costs, and we specialize in crafting tailored
                        solutions
                        using AI and Machine Learning according to the specific needs of a business, ensuring our
                        clients stay at
                        the forefront of innovation and efficiency in their valuable data management endeavors.
                    </p>
                </div>
            </div>
        </div>
...
<section class="buildfaster pt-0">
    <div class="container">
        ...
        <!-- <figure>
            ...
            <figure>
                <img src="{{ asset('web/images/cloud-mis-04.png') }}" alt="Dis">
                <figcaption>
            ...
            <figure>
                <div class="imgseccont">
                    <img src="{{ asset('web/images/cloud-mis-02.png') }}" alt="Dis"> -->
        ...
        <!-- </div>
                <figcaption>
                    <p> Upgrading from Equipment Breakdowns of a Manufacturing Plant to Significant Cost Savings by
                        AI-Driven
                        Maintenance on Microsoft Azure.
                    </p>
            ...
            <figure>
                <div class="imgseccont"> <img src="{{ asset('web/images/cloud-mis-05.png') }}" alt="Dis"></div>
                <figcaption>
            ...
            <figure>
                <div class="imgseccont">
                    <img src="{{ asset('web/images/cloud-mis-03.png') }}" alt="Dis"> -->
        <!-- <a href="#" class="videobtn">
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="17" viewBox="0 0 14 17" fill="none">
                <g clip-path="url(#clip0_1_123)">
        ...
        <!-- </div>
            ...
            <figure>
                <div class="imgseccont"> <img src="{{ asset('web/images/cloud-mis-06.png') }}" alt="Dis"></div>
                <figcaption>
