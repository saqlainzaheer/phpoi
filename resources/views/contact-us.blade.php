          ...
          <div class="allcontactform">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  <label>Email</label>
                  <input type="email" name="email" placeholder="demo@yopmail.com" class="form-control" value="" required>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <label>Phone Number</label>
                  <input type="text" name="phone_number" placeholder="Enter Phone Number"  class="form-control" value="" required>
                </div>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row mb-3">
              <div class="col-lg-3">
                <div class="form-check">
                  <input class="form-check-input"  type="radio" value="General Inquiry" name="inquiry" id="flexRadioDefault1">
              ...
              <div class="col-lg-3">
                <div class="form-check">
                  <input class="form-check-input" type="radio" value="General Inquiry" name="inquiry" id="flexRadioDefault2" checked>
              ...
              <div class="col-lg-3">
                <div class="form-check">
                  <input class="form-check-input" type="radio" value="General Inquiry" name="inquiry" id="flexRadioDefault3" checked>
              ...
              <div class="col-lg-3">
                <div class="form-check">
                  <input class="form-check-input" type="radio" value="General Inquiry" name="inquiry" id="flexRadioDefault4" checked>
