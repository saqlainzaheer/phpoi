...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="bi bi-table"></i> Update Service</h1>
        </div>
        ...
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    ...
                    <form class="form-horizontal" action="/admin/service/store/update/{{ $post->id }}" method="post"
                        enctype="multipart/form-data" onsubmit="return validateForm();">>
                        @csrf
                        <div class="mb-3 row">
                            <label for="title" class="form-label col-md-3">Service Title</label>
                            <div class="col-md-8">
                                <input class="form-control" id="title" value="{{ old('title', $post->title) }}"
                                    name="title" type="text" placeholder="Enter Service Title" maxlength="220">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="description" class="form-label col-md-3">Service Discription</label>
                            <div class="col-md-8">
                                <textarea style="width:100%; height:200px; " id="description" name="description"
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-3">
                            <button class="btn btn-primary" type="submit"><i
                                    class="bi bi-check-circle-fill me-2"></i>Add Service</button>
                            <a style="text-decoration:none; color:white;" class="btn-primary btn"
                                href="/admin/service/list">Back</a>
