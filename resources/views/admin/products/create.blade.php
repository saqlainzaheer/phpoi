...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="bi bi-table"></i> Add Product</h1>
        </div>
                ...
                <div class="tile-body">
                    ...
                    <form class="form-horizontal" action="{{ url('admin/products') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control col-md-8" name="title" type="text" placeholder="Enter Title" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="form-label col-md-3">Overview</label>
                            <div class="col-md-8">
                                <input class="form-control col-md-8" name="overview" type="text" placeholder="Enter OverView" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="form-label col-md-3">Specifications</label>
                            <div class="col-md-8">
                                <input class="form-control col-md-8" name="specification" type="text" placeholder="Enter Specification" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label class="form-label col-md-3">Product Picture</label>
                            <div class="col-md-8">
                                <input class="form-control col-md-8" name="image" type="file" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control col-md-8" name="pdf_file" type="file" required>
                            </div>
                        </div>
