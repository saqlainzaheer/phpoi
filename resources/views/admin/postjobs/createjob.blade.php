                ...
                <div class="tile-body">
                    <form class="form-horizontal" action="{{ route('job.store') }}" method="post">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" name="apply_last_date" type="date" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" name="designation" required>
                                    ...
                                    <option value="{{ $designation->designation }}">{{ $designation->designation }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea id="job_details" name="job_details">Hello, World!</textarea>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-3">
                                    <button class="btn btn-primary" type="submit">
                                        <i class="bi bi-check-circle-fill me-2"></i>Add Job
                                    </button>
